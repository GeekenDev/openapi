...
// AuthLoginPostOpts Optional parameters for the method 'AuthLoginPost'
type AuthLoginPostOpts struct {
 ...
 * @param optional nil or *AuthLoginPostOpts - Optional Parameters:
 * @param "InlineObject" (optional.Interface of InlineObject) - 
@return map[string]interface{}
*/
func (a *AuthApiService) AuthLoginPost(ctx _context.Context, localVarOptionals *AuthLoginPostOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
@return map[string]interface{}
*/
func (a *AuthApiService) AuthMeGet(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
